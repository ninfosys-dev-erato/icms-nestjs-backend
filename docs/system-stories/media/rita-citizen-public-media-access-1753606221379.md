...
**Generated**: 2025-07-27T08:50:21.379Z  
**Duration**: 0.06s  
**Status**: Failed  
**Test Results**: 5/8 steps passed
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:50:21.331Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "data": [],
  "meta": {
    "timestamp": "2025-07-27T08:50:21.340Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:50:21.351Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:50:21.367Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:50:21.374Z",
    "version": "1.0.0"
  }
}
```
...
❌ **Journey Encountered Issues**
        ...
        Rita Tamang completed 5 out of 8 steps successfully. 
        3 step(s) failed, preventing them from fully achieving 
        their goal of accessing government media as a citizen.
...
### Performance Metrics
- **browse-public-media**: 16ms ✅
- **view-public-albums**: 9ms ✅
- **search-community-photos**: 11ms ✅
- **view-specific-photo**: 0ms ❌
- **get-photo-url**: 0ms ❌
- **browse-images-only**: 13ms ✅
- **browse-album-contents**: 0ms ❌
- **search-health-content**: 10ms ✅

### ❌ Failed Steps
- **view-specific-photo**: Unknown error
- **get-photo-url**: Unknown error
- **browse-album-contents**: Unknown error