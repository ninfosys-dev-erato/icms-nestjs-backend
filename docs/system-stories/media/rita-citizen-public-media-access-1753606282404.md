...
**Generated**: 2025-07-27T08:51:22.404Z  
**Duration**: 0.07s  
**Status**: Failed  
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:51:22.344Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "data": [],
  "meta": {
    "timestamp": "2025-07-27T08:51:22.370Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:51:22.380Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:51:22.391Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:51:22.402Z",
    "version": "1.0.0"
  }
}
```
...
### Performance Metrics
- **browse-public-media**: 22ms ✅
- **view-public-albums**: 13ms ✅
- **search-community-photos**: 11ms ✅
- **view-specific-photo**: 0ms ❌
- **get-photo-url**: 0ms ❌
- **browse-images-only**: 10ms ✅
