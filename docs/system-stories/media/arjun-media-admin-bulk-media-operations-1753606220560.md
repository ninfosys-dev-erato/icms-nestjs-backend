...
**Generated**: 2025-07-27T08:50:20.560Z  
**Duration**: 0.34s  
**Status**: Success  
...
```json
{
  ...
  "data": {
    "user": {
      ...
      "lastLoginAt": null,
      "createdAt": "2025-07-27T08:50:20.205Z",
      "updatedAt": "2025-07-27T08:50:20.205Z"
    },
    "accessToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJjbWRsZnY3YWswMDBjanNsYnoxbGJxdmY5IiwiaWF0IjoxNzUzNjA2MjIwLCJqdGkiOiJjZTk2YzVkODZiMDkxMDgyZjU4NTkyYzQ2MmYzZTcyOCIsImV4cCI6MTc1MzYwOTgyMH0.VYvoKwAqEGz-IlX1zkQrTqZG_SiyY-qC61oOC4cE-F4",
    "refreshToken": "2295a721ab0c2cae4b81bdc65308d8f29aa6846246bb94847e17c009765a70c9358aae226f9bad87a31662d74fbf70b716c94d559075b4af66c9cdf95fd84a07",
    "expiresIn": "1h",
    "tokenType": "Bearer"
  },
  "meta": {
    "timestamp": "2025-07-27T08:50:20.434Z",
    "version": "1.0.0"
  }
}
```
...
**Headers**:
```
Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJjbWRsZnY3YWswMDBjanNsYnoxbGJxdmY5IiwiaWF0IjoxNzUzNjA2MjIwLCJqdGkiOiJjZTk2YzVkODZiMDkxMDgyZjU4NTkyYzQ2MmYzZTcyOCIsImV4cCI6MTc1MzYwOTgyMH0.VYvoKwAqEGz-IlX1zkQrTqZG_SiyY-qC61oOC4cE-F4
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:50:20.447Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "data": [
    {
      ...
      "createdAt": "2025-07-27T08:50:20.468Z",
      "updatedAt": "2025-07-27T08:50:20.468Z",
      "albums": []
    },
    {
      "id": "cmdlfv7hw000jjslb6tf7pzxn",
      "fileName": "education-policy-2024.pdf",
  ...
  "meta": {
    "timestamp": "2025-07-27T08:50:20.472Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "data": {
    ...
    "isActive": true,
    "createdAt": "2025-07-27T08:50:20.488Z",
    "updatedAt": "2025-07-27T08:50:20.488Z",
    "mediaCount": 0,
    "media": []
  },
  "meta": {
    "timestamp": "2025-07-27T08:50:20.491Z",
    "version": "1.0.0"
  }
}
```
...
{
  "ids": [
    "cmdlfv7hw000ijslbgur6l3fh",
    "cmdlfv7hw000jjslb6tf7pzxn"
  ],
  "updates": {
    "isActive": true,
    "altText": {
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:50:20.516Z",
    "version": "1.0.0"
  }
}
```
...
**API Call**: `POST /api/v1/admin/media/cmdlfv7hw000ijslbgur6l3fh/process`
...
```json
{
  ...
  "data": {
    ...
    "thumbnailUrl": "https://cdn.example.com/thumbnails/health-dept-event-1.jpg",
    "createdAt": "2025-07-27T08:50:20.468Z",
    "updatedAt": "2025-07-27T08:50:20.506Z",
    "albums": []
  },
  "meta": {
    "timestamp": "2025-07-27T08:50:20.530Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:50:20.541Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:50:20.556Z",
    "version": "1.0.0"
  }
}
```
...
### Performance Metrics
- **authenticate-admin**: 219ms ✅
- **check-system-statistics**: 13ms ✅
- **bulk-create-media**: 26ms ✅
- **create-department-albums**: 22ms ✅
- **bulk-update-metadata**: 20ms ✅
- **process-media-optimization**: 15ms ✅
- **verify-updated-statistics**: 13ms ✅
- **verify-content-organization**: 14ms ✅