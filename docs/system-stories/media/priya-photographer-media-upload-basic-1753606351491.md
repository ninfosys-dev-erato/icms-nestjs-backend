...
**Generated**: 2025-07-27T08:52:31.492Z  
**Duration**: 0.40s  
**Status**: Success  
...
```json
{
  ...
  "data": {
    "user": {
      ...
      "lastLoginAt": null,
      "createdAt": "2025-07-27T08:52:30.869Z",
      "updatedAt": "2025-07-27T08:52:30.869Z"
    },
    "accessToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJjbWRsZnkwNDUwMDAwanN1MnNiYmlxZjh5IiwiaWF0IjoxNzUzNjA2MzUxLCJqdGkiOiIzNzE4MDA1NzVlMWEyNjEyYTUxMWVhM2E0ZDY0ZDEzNCIsImV4cCI6MTc1MzYwOTk1MX0.Ds7pyABRqBt5lxFwiIGFOqOC3wiFvPJXxEu77aXIBCM",
    "refreshToken": "4f84db3ebf591c63fb28c8d689605cfb039f8962d4d1e77913e43283b586e2e6505e5649beae13310c8dee53c69787a5f4e2ee5ff73e241a214be9b24f9afe71",
    "expiresIn": "1h",
    "tokenType": "Bearer"
  },
  "meta": {
    "timestamp": "2025-07-27T08:52:31.311Z",
    "version": "1.0.0"
  }
}
```
...
**Headers**:
```
Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJjbWRsZnkwNDUwMDAwanN1MnNiYmlxZjh5IiwiaWF0IjoxNzUzNjA2MzUxLCJqdGkiOiIzNzE4MDA1NzVlMWEyNjEyYTUxMWVhM2E0ZDY0ZDEzNCIsImV4cCI6MTc1MzYwOTk1MX0.Ds7pyABRqBt5lxFwiIGFOqOC3wiFvPJXxEu77aXIBCM
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:52:31.346Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  "success": true,
  "data": {
    "id": "cmdlfy0ia0007jsu2jn6o2yo6",
    "fileName": "media/1753606351375-z4mhkszccb8-test-ceremony-photo.jpg",
    "originalName": "test-ceremony-photo.jpg",
    "filePath": "media/1753606351375-z4mhkszccb8-test-ceremony-photo.jpg",
    "fileSize": 24,
    "mimeType": "image/jpeg",
    "mediaType": "IMAGE",
    "altText": {
    ...
    "duration": null,
    "isActive": true,
    "url": "https://cdn.example.com/media/1753606351375-z4mhkszccb8-test-ceremony-photo.jpg",
    "thumbnailUrl": "https://cdn.example.com/thumbnails/media/1753606351375-z4mhkszccb8-test-ceremony-photo.jpg",
    "createdAt": "2025-07-27T08:52:31.379Z",
    "updatedAt": "2025-07-27T08:52:31.379Z",
    "albums": []
  },
  "meta": {
    "timestamp": "2025-07-27T08:52:31.386Z",
    "version": "1.0.0"
  }
}
```
...
**API Call**: `GET /api/v1/admin/media/cmdlfy0ia0007jsu2jn6o2yo6`
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:52:31.399Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "data": {
    ...
    "isActive": true,
    "createdAt": "2025-07-27T08:52:31.414Z",
    "updatedAt": "2025-07-27T08:52:31.414Z",
    "mediaCount": 0,
    "media": []
  },
  "meta": {
    "timestamp": "2025-07-27T08:52:31.419Z",
    "version": "1.0.0"
  }
}
```
...
**API Call**: `POST /api/v1/albums/cmdlfy0j90008jsu28cj8069c/media/cmdlfy0ia0007jsu2jn6o2yo6`
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:52:31.439Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:52:31.453Z",
    "version": "1.0.0"
  }
}
```
...
```json
{
  ...
  "meta": {
    "timestamp": "2025-07-27T08:52:31.487Z",
    "version": "1.0.0"
  }
}
```
...
### Performance Metrics
- **authenticate**: 223ms ✅
- **check-existing-media**: 39ms ✅
- **upload-first-photo**: 38ms ✅
- **verify-uploaded-photo**: 12ms ✅
- **create-event-album**: 20ms ✅
- **add-photo-to-album**: 20ms ✅
- **search-uploaded-content**: 16ms ✅
- **check-media-statistics**: 33ms ✅